              ...
              <mrl:LI_Lineage>
                ...
                <xsl:if test="position() = 1">
                  <mrl:source uuidref="{$sourceUuid}"
                              xlink:href="https://ecat.ga.gov.au/geonetwork/srv/eng/csw?service=CSW&amp;request=GetRecordById&amp;version=2.0.2&amp;outputSchema=http://standards.iso.org/iso/19115/-3/mdb/1.0&amp;elementSetName=full&amp;id={$sourceUuid}"/>
                </xsl:if>
